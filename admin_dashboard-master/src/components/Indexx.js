    ...
    <div id="wrapper">
      ...
      >
        ...
        <li className="nav-item">
          <a
            className={drag ? "nav-link" : "nav-link collapsed"}
            href="#"
          ...
          >
            ...
            <span onClick={() => setDrag(!drag)}>Components</span>
          </a>
          <div
            id="collapseTwo"
            className={drag ? "collapse show" : "collapse"}
        ...
        <li className="nav-item">
          <a
            className={drag1 ? "nav-link" : "nav-link collapsed"}
            href="#"
            data-toggle="collapse"
          ...
          >
            ...
            <span onClick={() => setDrag1(!drag1)}>Utilities</span>
          </a>
          <div
            id="collapseUtilities"
            className={drag1 ? "collapse show" : "collapse"}
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <a className="collapse-item" href="utilities-border.html">
                <NavLink to="/borders" style={{ textDecoration: "none" }}>
                  Borders
                </NavLink>
              </a>
              <a className="collapse-item" href="utilities-animation.html">
                <NavLink to="/animations" style={{ textDecoration: "none" }}>
                  Animations
                </NavLink>
              </a>
        ...
        <li className="nav-item">
          ...
          >
            ...
            <span onClick={() => setDrag2(!drag2)}>Pages</span>
          </a>
          <div
            id="collapsePages"
            className={drag2 ? "collapse show" : "collapse"}
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <a className="collapse-item" href="404.html">
                <NavLink to="/404-page" style={{ textDecoration: "none" }}>
                  404 Page
                </NavLink>
              </a>
              <a className="collapse-item" href="blank.html">
                <NavLink to="/blank-page" style={{ textDecoration: "none" }}>
                  Blank-Page
                </NavLink>
              </a>
            </div>
